...
urlpatterns = [
    ...
    path('ordenes/registro/', views.registro_pedidos, name='registro_pedidos'),
    path('ordenes/registro/descargar/', views.descargar_registro, name='descargar_registro'),
    path('ordenes/pagado/<int:pedido_id>/', views.pagado_pedido, name='pagado'),
    path('ordenes/cancelar/<int:pedido_id>/', views.cancelar_pedido, name='cancelar'),
